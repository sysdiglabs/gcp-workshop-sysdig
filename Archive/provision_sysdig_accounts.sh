...
if [ $# -ne 4 ]
  then
    ...
    ACCOUNT_PROVISIONER_MONITOR_API_TOKEN=fake-token-use-dynamic-value-1
    ACCOUNT_PROVISIONER_MONITOR_API_URL=https://us2.app.sysdig.com
    ACCOUNT_PROVISIONER_SECURE_API_TOKEN=fake-token-use-dynamic-value-2
    ACCOUNT_PROVISIONER_SECURE_API_URL=https://us2.app.sysdig.com
    ACCOUNT_PROVISIONER_AGENT_ACCESS_KEY=fake-token-use-dynamic-value-3
